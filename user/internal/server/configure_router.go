...
func (s *Server) ConfigureRouter() {
	...
	s.Router.Handle("POST", "/pets/delete/:id", pethandlers.DeletePets(store.New(s.Config)))
	...
	s.Router.Handle("POST", "/users/delete/:id", usershandlers.DeleteUser(store.New(s.Config)))
